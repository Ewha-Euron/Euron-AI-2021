...
Original file is located at
    https://colab.research.google.com/drive/1ecNLttXED2daoeqW1PlOhESbjnymHPOM
"""
...
FOLDERNAME = 'Euron_Ewha/cs231n/assignment3/'
...
**Your Answer:**<br> 
advantage - character 개수가 한정적이라(word의 개수는 매우 많음) 매우 작은 small vocabulary를 가지게 된다.<br>
disadvantage - larger sequence를 가지게 되기 때문에 parameter의 갯수가 늘어날 것이다. character-level의 경우, hidden layer의 개수가 character의 수와 같다. 그러나 word-level의 경우, hidden layer의 수가 5이다. parameter 수가 작으면 computationally efficient하고, vanishing/exploding gradient가 덜 발생할 수 있다.
