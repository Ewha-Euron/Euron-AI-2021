...
Original file is located at
    https://colab.research.google.com/drive/1CrW74xYKMiSjORJTWIWb-Ytg33lji-Ws
"""
...
**Your Answer:** No. Because final saliency map thus has shape (H, W), you can't use saliency map in each step to update the image which has shape (3, H, W)
